!function (t, e) {
    ...
    s.prototype = {
        init: function () {
            ...
            var e = new Date(1e3 * t), s = e.getUTCHours(),
                ...
                r = this.options.timeFormat.padSec && 10 > a ? "0" + a : a, l = "";
    ...
    t.jPlayer.convertTime = function (t) {
        ...
        var e = t.toLowerCase(), s = /(webkit)[ \/]([\w.]+)/, i = /(opera)(?:.*version)?[ \/]([\w.]+)/,
            a = /(msie) ([\w.]+)/, n = /(mozilla)(?:.*? rv:([\w.]+))?/,
        ...
        var e = t.toLowerCase(), s = /(ipad|iphone|ipod|android|blackberry|playbook|windows ce|webos)/,
            i = /(ipad|playbook)/, a = /(android)/, n = /(mobile)/, o = s.exec(e) || [],
    ...
    n.platform && (t.jPlayer.platform[n.platform] = !0, t.jPlayer.platform.mobile = !n.tablet, t.jPlayer.platform.tablet = !!n.tablet), t.jPlayer.getDocMode = function () {
        ...
        init: function () {
            var t, e, s, i = document, a = i.createElement("video"), n = {
            ...
            if (t.spec) {
                var l = n[t.spec];
                t.api = {
                    fullscreenEnabled: !0, fullscreenElement: function (t) {
    ...
    var o = function (e) {
        var s, i = t.jPlayer.focus, a = document.activeElement;
    ...
    t.jPlayer.keys = function (e) {
        ...
        _updateInterface: function () {
            ...
            var e = "", s = this.status.duration, i = this.status.remaining;
        ...
        tellOthers: function (e, s) {
            var i = this, a = "function" == typeof s, n = Array.prototype.slice.call(arguments);
        ...
        volumeBar: function (e) {
            if (this.css.jq.volumeBar.length) {
                var s = t(e.currentTarget), i = s.offset(), a = e.pageX - i.left, n = s.width(),
                    o = s.height() - e.pageY + i.top, r = s.height();
        ...
        playbackRateBar: function (e) {
            if (this.css.jq.playbackRateBar.length) {
                var s, i, a = t(e.currentTarget), n = a.offset(), o = e.pageX - n.left, r = a.width(),
                    l = a.height() - e.pageY + n.top, h = a.height();
        ...
        _html_play: function (t) {
            ...
            if (this.androidFix.pause = !1, this._html_load(), this.androidFix.setMedia) this.androidFix.play = !0, this.androidFix.time = t; else if (isNaN(t)) s.play(); else {
        ...
        _html_pause: function (t) {
            var e = this, s = this.htmlElement.media;
            if (this.androidFix.play = !1, t > 0 ? this._html_load() : clearTimeout(this.internal.htmlDlyCmdId), s.pause(), this.androidFix.setMedia) this.androidFix.pause = !0, this.androidFix.time = t; else if (!isNaN(t)) try {
                if (s.seekable && !("object" == typeof s.seekable && s.seekable.length > 0)) throw 1;
                s.currentTime = t
            } catch (i) {
                return void(this.internal.htmlDlyCmdId = setTimeout(function () {
